...
public class CreateStudentProfilePane extends GridPane {
	...
	public void setErrorPnumber(String error) {
		errorPnumber.setText(error);
	}
	public void errorFirstName(String error) {
		errorFirstName.setText(error);
	}
	public void errorSurname(String error) {
		errorSurname.setText(error);
	}
	public void errorEmail(String error) {
		errorEmail.setText(error);
	}
	public void errorDate(String error) {
		errorDate.setText(error);
	}
	
	public void resetAllErrorLabels() {
		errorPnumber.setText("");
